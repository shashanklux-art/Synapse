...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-[#0b1416]">
      ...
      <div className="bg-gradient-to-r from-[#58a6ff] to-[#238636] h-24"></div>
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="bg-[#1a1a1b] border border-[#343536] rounded mb-4">
          <div className="flex border-b border-[#343536]">
            <button className="px-4 py-2 text-sm font-semibold text-white border-b-2 border-[#58a6ff]">
              Posts
            </button>
                ...
                >
                  <div className="flex">
                    <div className="bg-[#161617] w-10 flex flex-col items-center py-2 gap-1">
                      ...
                      <span className={`text-xs font-bold ${totalVotes > 0 ? 'text-[#58a6ff]' : totalVotes < 0 ? 'text-[#238636]' : 'text-gray-400'}`}>
                        {totalVotes}
                      </span>
                      <svg className="w-5 h-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
